...
public class RunIntakeIn extends Command {
	...
	private static final double rightTrggerValue = 0;
    ...
    protected void execute() {
    	Joystick intakeController = Robot.oi.getDriveController();
