...
public class Ramps extends Subsystem {
    ...
    private final DoubleSolenoid releaseSolenoid1 = RobotMap.rampsSolenoidRelease1;
    private final DoubleSolenoid releaseSolenoid2 = RobotMap.rampsSolenoidRelease2;
    
    public void releaseRamps() {
    	releaseSolenoid1.set(Value.kForward);
    	releaseSolenoid2.set(Value.kForward);
    }
    ...
    public void holdRamps() {
    	releaseSolenoid1.set(Value.kReverse);
    	releaseSolenoid2.set(Value.kReverse);
    }
