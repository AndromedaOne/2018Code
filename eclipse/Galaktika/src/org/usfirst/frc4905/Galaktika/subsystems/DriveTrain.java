...
public class DriveTrain extends Subsystem {
	...
	private static final double kMaxVelocity = 130000; // Encoder ticks per second
	private static final double kMaxAcceleration = 51283873.833859; // Encoder ticks per second^2
	private static final double kMaxJerk = 100000;//43390740233.712463; // Encoder ticks per second^3
	private static final double kVelocityToOutputRatio = 1.0/kMaxVelocity;
	
	public static double getMaxVelocity() {return kMaxVelocity;}
	public static double getMaxAcceleration() {return kMaxAcceleration;}
	public static double getMaxJerk() {return kMaxJerk;}
   ...
   public void disableEncoderPID() {
    ...
    public double getPositionPIDOut(double setpoint) {
    		double encoderTicks = getEncoderTicks();
		double error = setpoint - encoderTicks;
		double positionPIDPreviousPositionError;
		if(Double.isNaN(m_positionPIDPreviousPosition)) {
			positionPIDPreviousPositionError = error;
		}else {
			positionPIDPreviousPositionError = setpoint - m_positionPIDPreviousPosition;
		}
		m_positionPIDIAccum += error;
		double pTerm = error*m_positionPIDkp;
		double iTerm = m_positionPIDIAccum*m_positionPIDki;
		double dTerm = (error - positionPIDPreviousPositionError)*m_positionPIDkd;
		
		m_positionPIDPreviousPosition = encoderTicks;
