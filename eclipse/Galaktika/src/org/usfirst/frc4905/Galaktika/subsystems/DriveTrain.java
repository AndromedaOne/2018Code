...
public class DriveTrain extends Subsystem {
	...
	public static final double ENCODER_TICKS_PER_INCH = 200;
   ...
   public void initializeEncoderPID(){
	...
	public void move(double forwardBackSpeed, double rotateAmount, boolean squaredInput) {
		...
		m_encoderTicksPassed = m_encoderTicksPassed + 1;
		System.out.println("encoderTicksPassed = " + m_encoderTicksPassed);
	}
	public void stop() {
