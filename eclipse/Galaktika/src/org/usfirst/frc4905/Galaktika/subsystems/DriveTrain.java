...
public class DriveTrain extends Subsystem {
	...
	private static final double kMaxJerk = 43390740233.712463; // Encoder ticks per second^3
	...
	public boolean gyroPIDIsDone() {
		Trace.getInstance().addTrace("GyroPID", new TracePair("Target", m_gyroPIDSource.getSetpoint()),
	...
	public void initializePositionMP() {
		...
		m_motionProfilingController = new MotionProfilingController(m_positionPIDkp, m_positionPIDki, m_positionPIDkd,
