...
public class OI {
	...
	public OI() {
		...
		talonMPButton.whenPressed(new RunTalonMP(10));
		*/
		...
		SmartDashboard.putData("RetractExtendArms", new RetractExtendArms());
        ...
        SmartDashboard.putData("TalonMP", new RunTalonMP(12000));
