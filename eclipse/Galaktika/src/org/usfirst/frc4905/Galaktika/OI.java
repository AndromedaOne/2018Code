...
public class OI {
    ...
    public JoystickButton elevatorMoveExcangeButton;
    public JoystickButton elevatorMoveSwitchButton;
    public JoystickButton elevatorMoveGroundButton;
    ...
    public OI() {
        ...
        runIntakeButton.whileHeld(new RunIntakeIn());
        elevatorMoveExcangeButton = new JoystickButton(subsystemController, 2);
        elevatorMoveSwitchButton = new JoystickButton(subsystemController, 3);
        elevatorMoveGroundButton = new JoystickButton(subsystemController, 1);
