...
public class Robot extends TimedRobot {
    ...
    public static final double DELAY_SECONDS = 5.0;
    ...
    public void robotInit() {
    		System.out.println("top of robotInit" );
    		RobotMap.init();
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        chooser.addObject("Middle Load Switch", new AutoMiddleLoadSwitch());
        chooser.addObject("Delayed Middle Load Switch", new AutoMiddleLoadSwitch(DELAY_SECONDS));
        chooser.addObject("Cross The Line", new AutoCrossTheLine());
        chooser.addObject("Delayed Cross The Line", new AutoCrossTheLine(DELAY_SECONDS));
        chooser.addObject("Quals", new AutoQuals());
        chooser.addObject("Delayed Quals", new AutoQuals(DELAY_SECONDS));
        chooser.addObject("Playoffs", new AutoPlayoffs());
        chooser.addObject("Delayed Playoffs", new AutoPlayoffs(DELAY_SECONDS));
        ...
        System.out.println("bottom of robotInit" );
    }
    ...
    public void autonomousInit() {
    		System.out.println("top of Robot autonomousInit");
    ...
    public static char getSwitchPlatePosition() {
    	System.out.println("top of Robot getSwitchPlatePosition");
    ...
    public static char getScalePlatePosition() {
    	System.out.println("top of Robot getScalePlatePosition");
    	String gameData = DriverStation.getInstance().getGameSpecificMessage();
    ...
    public static char getInitialRobotLocation() {
	    	System.out.println("top of Robot getInitialRobotLocation");
