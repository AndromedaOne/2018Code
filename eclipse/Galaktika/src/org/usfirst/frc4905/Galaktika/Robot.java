...
public class Robot extends TimedRobot {
    ...
    private SendableChooser<Character> locationChooser = new SendableChooser<>();
    ...
    public static char getScalePlatePosition() {
		...
		debug("getScalePlatePosition returning " + scalePlatePosition);
    ...
    public static char getSwitchPlatePosition() {
		...
		debug("getSwitchPlatePosition returning " + switchPlatePosition);
