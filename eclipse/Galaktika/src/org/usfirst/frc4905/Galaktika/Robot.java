...
public class Robot extends TimedRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        chooser.addObject("Delayed Middle Load Switch", new AutoDelayedMiddleLoadSwitch());
        chooser.addObject("Cross The Line", new AutoCrossTheLine());
        chooser.addObject("Delayed Cross The Line", new AutoDelayedCrossTheLine());
        chooser.addObject("Quals", new AutoQuals());
        chooser.addObject("Delayed Quals", new AutoDelayedQuals());
        chooser.addObject("Playoffs", new AutoPlayoffs());
        chooser.addObject("Delayed Playoffs", new AutoDelayedPlayoffs());
