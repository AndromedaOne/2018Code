...
public class RobotMap {
    ...
    public static GearTooth driveTrainGearToothSensor1;
    ...
    public static void init() {
        ...
        driveTrainGearToothSensor1 = new GearTooth(0, false);
        LiveWindow.addSensor("DriveTrain", "Gear Tooth Sensor 1", driveTrainGearToothSensor1);
        ...
        elevatorElevatorContoller = new WPI_TalonSRX(1);
