...
public class RobotMap {
	...
	public static DigitalInput cubeDetectorLeft;
	public static DigitalInput cubeDetectorRight;
	...
	public static void init() {
		...
		driveTrainLeftTopTalon.setInverted(true);

		driveTrainLeftBottomTalon = new WPI_TalonSRX(2);
		driveTrainLeftBottomTalon.setInverted(true);
		...
		driveTrainRightTopTalon.setInverted(true);

		driveTrainRightBottomTalon = new WPI_TalonSRX(4);
		driveTrainRightBottomTalon.setInverted(true);
		...
		driveTrainFrontUltrasonic = new Ultrasonic(1, 0);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
		...
		cubeDetectorLeft = new DigitalInput(2);
		cubeDetectorRight = new DigitalInput(3);
		...
		leftDeployServo = new Servo(6);
		rightDeployServo = new Servo(5);
		LiveWindow.addSensor("Cube Detector", "Left Cube Detector", cubeDetectorLeft);
		LiveWindow.addSensor("Cube Detector", "Right Cube Detector", cubeDetectorRight);
